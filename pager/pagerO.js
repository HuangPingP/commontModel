/*
	...
	使用说明*****************
	var pager = require("js/lib/pager");
	pager.getPage({
		"id": "pagerId", 	//外层div的id
		"page" : 1,			//当前页
		"totalPage" : "6",	//总页数
		"preBtnClick": preBtnClick,//上一页点击事件
		"nextBtnClick": nextBtnClick,//下一页点击事件
		"toSomePageClick": toSomePageClick,//跳转到某一页点击事件
