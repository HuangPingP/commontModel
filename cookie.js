 ...
 * @return {Void}
 */
export function setCookie(key: string, value: string, option: Object|void): void {
    key = encode(key);
    value = encode(value);
 ...
 * @return {String}
 */
function computedOption(option: Object): string {
    let optionString = '';
...
function computedExpires(expires: string): string {
